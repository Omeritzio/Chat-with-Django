...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\User\OneDrive\שולחן העבודה\chat\djangochat_env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\User\OneDrive\שולחן העבודה\chat\djangochat_env\Scripts\deactivate.nu'
